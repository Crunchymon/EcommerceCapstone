        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <nav aria-label="Footer Navigation" className="flex justify-center">
              <ul className="flex flex-col gap-2 text-gray-300 md:text-left  w-1/4">
                <li>
          ...
          <div className="text-center flex flex-col gap-2">
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-center gap-4">
                ...
                <a href="https://github.com/Crunchymon/EcommerceCapstone" aria-label="GitHub" className="hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 rounded">
